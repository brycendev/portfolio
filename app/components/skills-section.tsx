...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "REST APIs", icon: "https://image.pngaaa.com/597/6267597-middle.png" },
    ],
  },
  {
    label: "Databases",
  ...
  },
  {
    ...
    skills: [
      { name: "Generative AI", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/openai/openai-original.svg" },
      { name: "AI Agents", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" },
      { name: "AI Integrations", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" },
      { name: "Workflow Automation", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/n8n/n8n-original.svg" },
    ],
  },
  {
    label: "Cloud & DevOps",
