...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/brycendev", label: "GitHub", hover: "hover:text-white hover:bg-white/10" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/brycenwong/", label: "LinkedIn", hover: "hover:text-blue-400 hover:bg-blue-400/10" },
    { icon: Mail, href: "mailto:brycedev0525@gmail.com", label: "Email", hover: "hover:text-cyan-400 hover:bg-cyan-400/10" },
  ]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            ...
            <p className="text-gray-400 mb-8 leading-relaxed max-w-md">
              Senior Full-Stack Developer and AI Engineer building scalable AI, Mobile and Web products.
            </p>
          ...
          <div className="md:col-span-3 lg:col-span-4 lg:justify-self-end">
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <p className="flex items-center hover:text-white transition-colors">
                <a href="mailto:brycedev0525@gmail.com">brycedev0525@gmail.com</a>
              </p>
        ...
        <div className="pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm text-center md:text-left">
            &copy; {currentYear} brycenwong.dev. All rights reserved.
          </p>
