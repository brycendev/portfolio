...
export default function ContactSection() {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/brycendev", label: "GitHub", color: "hover:text-white" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/brycenwong/", label: "LinkedIn", color: "hover:text-blue-400" },
  ]
                ...
                <div className="space-y-8">
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <a href="" target="_blank" rel="noopener noreferrer" className="text-white font-medium hover:text-emerald-400 transition-colors break-all">brycenwong.dev</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <a href="mailto:brycedev0525@gmail.com" className="text-white font-medium hover:text-cyan-400 transition-colors break-all">brycedev0525@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">San Jose, California, US</p>
                    </div>
                  </div>
                </div>
