        ...
        <section id="home" className="h-screen w-full relative overflow-hidden bg-black">
            <HeroScene />
                ...
                >
                    ...
                    >
                        Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">Brycen</span>
                    </motion.h1>
                    ...
                    >
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Senior Full-Stack Developer & AI Engineer</span> with 10+ years of experience building scalable web applications, SaaS platforms, AI solutions, APIs, and cloud-based systems.
                    </motion.p>
                    ...
                    >
                        ...
                        <MagneticWrapper range={60}>
                            <a
                                href="https://github.com/brycendev"
                                target="_blank"
