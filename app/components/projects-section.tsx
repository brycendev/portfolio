...
import { ExternalLink, Github, Code2, Rocket, Layout, Server, Database, CloudOff, Brain, BookCheck, BookCopy, GraduationCap, CloudSun, MessageSquareCode, Plane, Share, Users, Trophy, Briefcase, Lock, Star, Mail, Key } from "lucide-react";
...
const featuredProjects = [
  {
    title: "Div-idy",
    label: "AI Web Development Assistant",
    image: "/project_div-idy.png",
    description: "An AI-powered SaaS platform designed to support web development workflows with intelligent assistance, automated coding tasks, and developer productivity tools.",
    features: [
      "AI-assisted web development workflows",
      "Intelligent coding and development support",
      "Backend services and API integrations",
      "Cloud-based application infrastructure",
      "Developer-focused SaaS experience",
      "Scalable architecture for future expansion",
    ],
    tags: ["JavaScript", "Node.js", "Python", "Express.js", "Firebase", "Cloudflare"],
    links: { demo: "https://div-idy.com/", github: "" },
    icon: <Users className="w-8 h-8 text-emerald-400" />,
    impact: "AI SaaS Tool for Web Development",
    isPrivate: true,
    gradient: "from-emerald-500/20 to-teal-600/20",
    borderGlow: "hover:border-emerald-500/40",
    impactDetails: [
      "Simplifies common web development tasks",
      "Improves developer productivity through AI assistance",
      "Combines JavaScript, Node.js, Python, and cloud technologies",
    ],
  },
  {
    title: "PlainSums",
    label: "Financial Calculator Website",
    image: "/project_plainsums.png",
    description: "A modern financial calculator website built to help users perform financial calculations through a simple, responsive, and easy-to-use interface.",
    features: [
    ...
    links: { demo: "https://www.plainsums.com/", github: "" },
    icon: <Brain className="w-8 h-8 text-purple-400" />,
    impact: "Interactive Financial Calculation Platform",
    isPrivate: true,
    gradient: "from-purple-500/20 to-pink-600/20",
    borderGlow: "hover:border-purple-500/40",
    impactDetails: [
      "Makes financial calculations easier for everyday users",
      "Provides a fast and accessible web experience",
      "Delivers a clean interface across desktop and mobile devices",
    ],
  },
  {
    title: "Starfish",
    label: "Influencer Marketing App",
    image: "/project_starfish.png",
    description: "A mobile application designed to connect brands and influencers, helping manage influencer marketing campaigns, collaborations, and promotional opportunities.",
    features: [
      "Influencer and brand profiles",
      "Campaign and collaboration workflows",
    ...
    links: { demo: "https://apps.apple.com/us/app/starfish-influencer-marketing/id6462732289", github: "" },
    icon: <Share className="w-8 h-8 text-cyan-400" />,
    impact: "Influencer Marketing & Collaboration Platform",
    isPrivate: true,
    gradient: "from-cyan-500/20 to-blue-600/20",
    borderGlow: "hover:border-cyan-500/40",
    impactDetails: [
      "Simplifies communication between brands and influencers",
      "Supports influencer marketing campaign management",
      "Delivers a smooth cross-platform mobile experience",
    ],
  },
  {
    title: "SeatSwiper",
    label: "Restaurant Booking Platform",
    image: "/project_seatswipe.png",
    description: "A restaurant booking platform designed to help users discover restaurants and make reservations through a convenient online experience.",
    features: [
      "Restaurant discovery and browsing",
      "Online table reservation workflows",
      "User-friendly booking experience",
      "Responsive restaurant listing pages",
      "Booking and availability management",
      "Web application optimized for performance",
    ],
    tags: ["React.js", "Local LLMs (Qwen)", "Node.js", "PostgreSQL", "Tailwind CSS"],
    links: { demo: "https://www.seatswiper.com/", github: "" },
    icon: <BookCheck className="w-8 h-8 text-purple-400" />,
    impact: "Online Restaurant Reservation Platform",
    isPrivate: true,
    gradient: "from-purple-500/20 to-pink-600/20",
    borderGlow: "hover:border-purple-500/40",
    impactDetails: [
      "Simplifies the restaurant reservation process",
      "Connects customers with restaurant booking services",
      "Provides an accessible experience across desktop and mobile devices",
    ],
  },
];
...
const otherProjects = [
  {
    ...
    links: { demo: "http://global-smile-lc5h.onrender.com/", github: "" },
  ...
  },
  {
    ...
    links: { demo: "http://studentconnect-sjc1.onrender.com/", github: "" },
  ...
  },
  {
    ...
    links: { demo: "https://bug-bounty-j687.onrender.com/", github: "" },
    icon: <Trophy className="w-8 h-8 text-amber-400" />,
  ...
  },
  {
    ...
    links: { demo: "https://lumoraed.onrender.com/", github: "" },
  ...
  },
  {
    ...
    links: { demo: "https://weather-dashboard-wmdm.vercel.app/", github: "" },
      ...
      <motion.div whileHover={{ y: -6 }} transition={{ type: "spring", stiffness: 300, damping: 20 }} className="h-full">
        ...
        <SpotlightCard className={`h-full bg-neutral-900/80 border-neutral-800 ${project.borderGlow} transition-all duration-300`}>
          <div className="p-6 sm:p-8 relative z-20 h-full flex flex-col">
            ...
            <div className="w-full h-80 rounded-xl mb-6 border border-white/10 overflow-hidden shrink-0">
              {project.image ? (
                <img
                  src={project.image}
                  alt={project.title}
                ...
                <div className={`w-full h-80 rounded-xl mb-6 bg-gradient-to-br ${project.gradient} border border-white/10 flex items-center justify-center overflow-hidden shrink-0`}>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">
            Highlights from my work — production systems, and emerging AI platforms.
          </p>
        </ScrollReveal>
