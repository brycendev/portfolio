...
export default function ResumePage() {
  return (
    <div className="min-h-screen bg-neutral-950 flex flex-col items-center pt-8 pb-8 px-4 relative">
      ...
      >
        <div className="w-full relative overflow-hidden" style={{ aspectRatio: '1 / 6', minHeight: '150vh' }}>
          {/* Desktop PDF Viewer */}
          {/* <iframe
          ...
          <iframe
            src="/resume.pdf#toolbar=0&navpanes=0&scrollbar=0&view=FitH"
            className="hidden md:block absolute top-0 left-0 w-full h-full border-none"
            title="Resume Desktop"
          />

          {/* Mobile PDF Viewer (Google Docs) */}
          <iframe
            src="https://docs.google.com/document/d/1QfeEIxBe0z0eOdyGODbhBYqc2vGCwxl7Mw7wLRIFr0g/edit?tab=t.0"
